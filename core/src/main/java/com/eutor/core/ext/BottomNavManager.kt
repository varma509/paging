...
class BottomNavManager(
  ...
  private var navHistory = BottomNavHistory().apply { push(homeNavId) }
  ...
  private fun isFirstTab(): Boolean {
    return bottomNavigationView.selectedItemId ==homeNavId
  }
